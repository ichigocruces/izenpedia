...
public class PopularBoyFragment extends BaseFragment {

    public PopularBoyFragment() {
        super();
    }
    ...
    public void onAttach(Context context){
        ...
        izenaAdapter = new IzenaAdapter(izenaDAO.getPopularIzenak(Constants.GIZONA), this, _listType);
